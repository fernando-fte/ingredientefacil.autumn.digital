        ...
        <form class="modal-content" method="post" action="{{ $route ?? '' }}">
            ...
            <div class="modal-body">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="nome" value="{{ $name ?? '' }}" placeholder="Ex: Pão Italiano" required>
                </div>

                <div class="row g-2 mb-3">
                    <div class="col-4">
                        <label class="form-label">Rendimento <span class="text-danger">*</span></label>
                        <input type="number" step="0.01" class="form-control" name="rendimento_valor" value="{{ $yield ?? '' }}" required>
                    </div>
                    <div class="col-2">
                    ...
                    <div class="col-4">
                        ...
                        <input type="number" class="form-control" name="porcoes" value="{{ $portions ?? '' }}" required>
                    </div>
                </div>
